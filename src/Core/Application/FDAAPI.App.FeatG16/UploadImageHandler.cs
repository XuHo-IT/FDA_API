...
namespace FDAAPI.App.FeatImages
{
    public class UploadImageHandler : IFeatureHandler<UploadImageRequest, UploadImageResponse>
    {
        ...
        private readonly FDAAPI.App.Common.Services.Policies.IImageUploadPolicy? _policy;

        public UploadImageHandler(IImageStorageService storage, FDAAPI.App.Common.Services.Policies.IImageUploadPolicy? policy = null)
        {
            _storage = storage;
            _policy = policy;
        }
