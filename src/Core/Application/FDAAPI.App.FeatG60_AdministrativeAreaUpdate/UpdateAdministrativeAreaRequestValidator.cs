...
{
    public class UpdateAdministrativeAreaRequestValidator : AbstractValidator<UpdateAdministrativeAreaRequest>
    {
        public UpdateAdministrativeAreaRequestValidator()
        {
            RuleFor(x => x.Id)
