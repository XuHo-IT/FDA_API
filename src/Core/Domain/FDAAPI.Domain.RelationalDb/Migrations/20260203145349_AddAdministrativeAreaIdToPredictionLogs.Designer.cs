...
namespace FDAAPI.Domain.RelationalDb.Migrations
{
    ...
    [Migration("20260203145349_AddAdministrativeAreaIdToPredictionLogs")]
    partial class AddAdministrativeAreaIdToPredictionLogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FDAAPI.Domain.RelationalDb.Entities.AlertCooldownConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CooldownMinutes = 30,
                            CreatedAt = new DateTime(2026, 2, 3, 14, 53, 48, 122, DateTimeKind.Utc).AddTicks(6450),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Low priority alerts - 30 min cooldown",
                            IsActive = true,
                            MaxNotificationsPerHour = 2,
                            Severity = "info",
                            UpdatedAt = new DateTime(2026, 2, 3, 14, 53, 48, 122, DateTimeKind.Utc).AddTicks(6450),
