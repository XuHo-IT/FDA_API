...
namespace FDAAPI.Domain.RelationalDb.Migrations
{
    ...
    [Migration("20260128171655_AddTypeColumnToStations")]
    partial class AddTypeColumnToStations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FDAAPI.Domain.RelationalDb.Entities.AlertCooldownConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CooldownMinutes = 30,
                            CreatedAt = new DateTime(2026, 1, 28, 17, 16, 53, 488, DateTimeKind.Utc).AddTicks(5070),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Low priority alerts - 30 min cooldown",
                            IsActive = true,
                            MaxNotificationsPerHour = 2,
                            Severity = "info",
                            UpdatedAt = new DateTime(2026, 1, 28, 17, 16, 53, 488, DateTimeKind.Utc).AddTicks(5070),
