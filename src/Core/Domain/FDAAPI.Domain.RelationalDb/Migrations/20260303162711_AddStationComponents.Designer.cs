...
namespace FDAAPI.Domain.RelationalDb.Migrations
{
    ...
    [Migration("20260303162711_AddStationComponents")]
    partial class AddStationComponents
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FDAAPI.Domain.RelationalDb.Entities.AlertCooldownConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CooldownMinutes = 30,
                            CreatedAt = new DateTime(2026, 3, 3, 16, 27, 9, 974, DateTimeKind.Utc).AddTicks(7168),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Low priority alerts - 30 min cooldown",
                            IsActive = true,
                            MaxNotificationsPerHour = 2,
                            Severity = "info",
                            UpdatedAt = new DateTime(2026, 3, 3, 16, 27, 9, 974, DateTimeKind.Utc).AddTicks(7168),
