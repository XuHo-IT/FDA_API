using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat17_AuthCheckIdentifier.DTOs;
using FastEndpoints;
using FDAAPI.App.Common.Features;
using FDAAPI.App.FeatG17_AuthCheckIdentifier;
using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat17_AuthCheckIdentifier;
using MediatR;

namespace FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat17_AuthCheckIdentifier{
    /// <summary>
