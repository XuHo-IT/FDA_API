...
using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat6_AuthSendOtp.DTOs;
using MediatR;

namespace FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat6_AuthSendOtp{
    /// <summary>
