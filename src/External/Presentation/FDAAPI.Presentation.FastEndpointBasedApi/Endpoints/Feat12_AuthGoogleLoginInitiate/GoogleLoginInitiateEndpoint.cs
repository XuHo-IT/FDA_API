using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat12_AuthGoogleLoginInitiate.DTOs;
using FastEndpoints;
using FDAAPI.App.Common.Features;
using FDAAPI.App.FeatG12_AuthGoogleLoginInitiate;
using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat12_AuthGoogleLoginInitiate;
using MediatR;

namespace FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat12_AuthGoogleLoginInitiate{
    /// <summary>
