...
using FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat1_WaterLevelCreate.DTOs;
using FastEndpoints;

namespace FDAAPI.Presentation.FastEndpointBasedApi.Endpoints.Feat1_WaterLevelCreate{
    /// <summary>
